...
// In-memory storage with MongoDB-compatible structure
export class HybridStorage implements IStorage {
  ...
  private seedData() {
    // Seed with sample data that matches the existing portfolio structure
    this.overview = {
      id: randomUUID(),
    ...
    this.about = {
      ...
      content: "I'm a passionate developer exploring the intersection of technology and space. With years of experience in web development, I create stellar applications that push the boundaries of what's possible.",
      experiences: [
        "5+ years in Full-Stack Development",
        "Lead Developer at Space Tech Solutions",
        "Contributor to Open Source Space Projects",
        "Certified in Advanced Web Technologies"
      ],
      achievements: [
