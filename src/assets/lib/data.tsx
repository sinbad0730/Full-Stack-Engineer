...
export const projectsData = [
  {
    title: "Tasty App",
    description:
      "Um aplicativo de receitas que construímos em equipe com React e a API MealDB. Fui o desenvolvedor front-end e programei recursos como pesquisa por voz e impressão em PDF. O design foi criado com Figma. O site é responsivo e otimizado para dispositivos móveis.",
    description_EN:
    ...
    githuburl: "https://github.com/ElielsonC/Frontend_Abschlussprojekt_Tasty",
    githubicon: FiGithub,
  ...
  },
  {
    title: "Silentmoon",
    description:
      "Um aplicativo de yoga e meditação que construímos em equipe com React, MongoDB, Express e Node.js. Minha tarefa como gitmaster e desenvolvedor backend foi programar o backend com conexão usando uma API RESTful e modelar o banco de dados no MongoDB.",
    description_EN:
    ...
    githuburl:
      "https://github.com/ElielsonC/Fullstack_Abschlussprojekt_SilentMoon",
    githubicon: FiGithub,
    deploymenticon: FiLink,
    colors: {
      main: "main-btn",
  ...
  },
  {
    ...
    description:
      "Um aplicativo organizador de móveis que programamos como equipe dupla com React, MongoDB, Express e Node.js. Como gitmaster, assumi a conexão do frontend ao backend e a modelagem do banco de dados. O aplicativo é responsivo e otimizado para dispositivos móveis.",
    description_EN:
    ...
    githuburl: "https://github.com/ElielsonC/Furniture_MERN",
    githubicon: FiGithub,
    deploymenticon: FiLink,
    colors: {
      main: "main-btn",
...
export const sideBarRightMail = {
  link: "mailto:elielsonworkfp@gmail.com",
  text: "elielsonworkfp@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/elielson-ferreira-41a9a2388/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/dangerous-lorex",
    icon: FiGithub,
    altimgname: "github",
  },
  {
  ...
  paragraphs_PT: [
    {
      ...
      description:
        "Quando não estou navegando no mundo digital, exploro o fascinante reino da tecnologia e hardware. Circuitos e juntas de solda são como peças de quebra-cabeça para mim em uma aventura emocionante.",
      icon: hardwareicon,
    },
    {
      title: "Na Pista Rápida da Vida",
      description:
        "Além de programar, gosto de estar na pista rápida - no sentido mais literal da palavra. Carros são minha paixão, e eu adoro estar em estradas desconhecidas com máquinas potentes.",
      icon: caricon,
    },
    {
      title: "A Alegria da Descoberta como Lema de Vida",
      description:
        "Minha jornada como desenvolvedor web é apenas uma parte do meu caminho de vida. Vivo pelo lema de que a aventura só começa quando você deixa o familiar para trás. Descobrir novos lugares e culturas é minha forma de inspiração criativa.",
      icon: travelicon,
    },
  ],
  paragraphs_EN: [
